...
export class AddAttachmentsToMaterialReturn1598175084648 implements MigrationInterface {
    name = 'AddAttachmentsToMaterialReturn1598175084648'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "material_return" ADD "attachments" text array NOT NULL DEFAULT '{}'::text[]`, undefined);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "material_return" DROP COLUMN "attachments"`, undefined);
    }
