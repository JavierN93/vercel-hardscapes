...
export class AddPrecesionToSubContractMilestoneAmount1598195868746 implements MigrationInterface {
    name = 'AddPrecesionToSubContractMilestoneAmount1598195868746'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "sub_contract_milestone" DROP COLUMN "amount"`, undefined);
        await queryRunner.query(`ALTER TABLE "sub_contract_milestone" ADD "amount" numeric(17,2) NOT NULL`, undefined);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "sub_contract_milestone" DROP COLUMN "amount"`, undefined);
        await queryRunner.query(`ALTER TABLE "sub_contract_milestone" ADD "amount" integer NOT NULL`, undefined);
