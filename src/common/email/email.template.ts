...
export const EmailTemplateContents = {
  ...
  [EmailType.Invitation]: `Hi {{name}},<br>You are invited to {{companyName}}.<br>Your temporary password is '{{tempPassword}}'. Use this password to set a new password in this link: <a href="{{passwordResetLink}}">{{passwordResetLink}}</a><br>This link expires in {{linkExpireHours}} hour(s).`,
