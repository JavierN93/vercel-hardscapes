...
export const defaultProcedureSteps = [
  {
    title: 'Excavation',
    comment: `${globalConfig.companyName} will dig to a minimum depth of 12”, or till suitable subsoil is exposed typically no more than 18”, upon exposure the subsoil will be leveled out and compacted in preparation for Geo-Textile fabric.`,
  },
  {
    title: 'Geo-textile',
  ...
  {
    title: 'Base',
    comment: `${globalConfig.companyName} will bring in clean ¾ inch process gravel (Or trap rock depending on subsoil) that will be laid out in 3 to 4-inch lifts and compacted to a 98% compaction ratio and brought up to the proper grade.`,
  },
  {
    title: 'Screeding',
